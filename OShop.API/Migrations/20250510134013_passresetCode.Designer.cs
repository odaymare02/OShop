...
namespace OShop.API.Migrations
{
    ...
    [Migration("20250510134013_passresetCode")]
    partial class passresetCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OShop.API.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("OShop.API.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OShop.API.Models.ApplicationUser", null)
                        .WithMany()
